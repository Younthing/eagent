...
def _risk_d4(answers: Mapping[str, AnswerOption]) -> tuple[DomainRisk, RuleTrace]:
    ...
    if q4_2 in NO_OR_NI:
        if q4_3 in NO:
            return "low", trace + ["D4:R3 q4_2 in NO/NI & q4_3 in NO -> low"]
        if q4_3 in YES_OR_NI:
            if q4_4 in NO:
                return "low", trace + ["D4:R4 q4_2 in NO/NI & q4_3 in YES/NI & q4_4 in NO -> low"]
            if q4_4 in YES_OR_NI:
                if q4_5 in NO:
                    return "some_concerns", trace + ["D4:R5 q4_2 in NO/NI & q4_3 in YES/NI & q4_4 in YES/NI & q4_5 in NO -> some_concerns"]
                if q4_5 in YES_OR_NI:
                    return "high", trace + ["D4:R6 q4_2 in NO/NI & q4_3 in YES/NI & q4_4 in YES/NI & q4_5 in YES/NI -> high"]
