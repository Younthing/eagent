...
**第 1 部分：输入 2.1–2.5 → 输出**

| 条件组合                                                                                  | 判定                |
| ------------------------------------------------------------------------------------- | ----------------- |
| 2.1 = **N/PN** 且 2.2 = **N/PN**                                                          | **Low**           |
| 2.1 或 2.2 任一为 **Y/PY/NI**，且 2.3 = **N/PN**                                                 | **Low**           |
| 2.1 或 2.2 任一为 **Y/PY/NI**，且 2.3 = **NI**                                                   | **Some concerns** |
| 2.1 或 2.2 任一为 **Y/PY/NI**，且 2.3 = **Y/PY**，且 2.4 = **N/PN**                                  | **Some concerns** |
| 2.1 或 2.2 任一为 **Y/PY/NI**，且 2.3 = **Y/PY**，且 2.4 = **Y/PY/NI**，且 2.5 = **Y/PY**              | **Some concerns** |
| 2.1 或 2.2 任一为 **Y/PY/NI**，且 2.3 = **Y/PY**，且 2.4 = **Y/PY/NI**，且 2.5 = **N/PN/NI**            | **High**          |

**第 2 部分：输入 2.6 / 2.7 → 输出**
...
**领域合并判定（第 1 部分 + 第 2 部分）**

| 条件组合                                          | 领域判定             |
| --------------------------------------------- | ---------------- |
| 第 1 部分和第 2 部分均为 **Low**                            | **Low**          |
| 第 1 部分或第 2 部分任一为 **High**                         | **High**         |
| 其他情况（即至少一部分为 **Some concerns** 且无 **High**） | **Some concerns** |

---

## **Domain 2：偏离既定干预（effect of adherence）**

**输入：2.1–2.6 → 输出**

| 条件组合                                                                                         | 判定                |
| ---------------------------------------------------------------------------------------------- | ----------------- |
| 2.1 = **N/PN** 且 2.2 = **N/PN**，2.4 = **NA/N/PN** 且 2.5 = **NA/N/PN**                             | **Low**           |
| 2.1 或 2.2 任一为 **Y/PY/NI**，2.3 = **NA/Y/PY**，2.4 = **NA/N/PN** 且 2.5 = **NA/N/PN**               | **Low**           |
| 2.1 = **N/PN** 且 2.2 = **N/PN**，2.4 或 2.5 任一为 **Y/PY/NI**，2.6 = **Y/PY**                       | **Some concerns** |
| 2.1 或 2.2 任一为 **Y/PY/NI**，2.3 = **NA/Y/PY**，2.4 或 2.5 任一为 **Y/PY/NI**，2.6 = **Y/PY**         | **Some concerns** |
| 2.1 或 2.2 任一为 **Y/PY/NI**，2.3 = **N/PN/NI**，2.6 = **Y/PY**                                      | **Some concerns** |
| 2.1 = **N/PN** 且 2.2 = **N/PN**，2.4 或 2.5 任一为 **Y/PY/NI**，2.6 = **N/PN/NI**                      | **High**          |
| 2.1 或 2.2 任一为 **Y/PY/NI**，2.3 = **NA/Y/PY**，2.4 或 2.5 任一为 **Y/PY/NI**，2.6 = **N/PN/NI**        | **High**          |
| 2.1 或 2.2 任一为 **Y/PY/NI**，2.3 = **N/PN/NI**，2.6 = **N/PN/NI**                                     | **High**          |
...
#### 3.1 D5 q5_2 / q5_3 的证据判定补充

- 仅有“多时间点 / 多阈值(截断值) / 多统计检验 / 方法中提到多种可能分析”，不足以将 q5_2 或 q5_3 判为 **Y/PY**。
- 仅当证据中存在“直接选择性报告证据”时，q5_2/q5_3 才可判 **Y/PY**，例如：
  - 方法列出多个可选测量/分析，结果仅报告其中一个，且无说明。
  - 证据中给出预注册/方案/SAP，并与发表报告存在无合理说明的不一致。
- 当无法核验“预设方案 + 选择透明度”时，q5_2/q5_3 默认倾向 **NI**。

#### 3.2 Overall Risk 聚合规则（当前实现）

| 条件 | Overall 判定 |
| --- | --- |
| 任一 domain = **High** | **High** |
| 所有 domain = **Low** | **Low** |
| 无 High，且 Some concerns 的 domain 数量为 **4–5** | **High** |
| 无 High，且 Some concerns 的 domain 数量为 **1–3** | **Some concerns** |
| 无任何 domain 结果 | **Not applicable** |
